namespace OpenAPI2Word.CommunityToolkit.Extensions
{
    ...
    {
        public static void AddHeader(this XWPFDocument doc, string content, int c = 0)
        {
            doc.Document.body.sectPr = new CT_SectPr();
            CT_SectPr m_SectPr = doc.Document.body.sectPr;
            //创建页眉
            CT_Hdr m_Hdr = new CT_Hdr();
            m_Hdr.AddNewP().AddNewR().AddNewT().Value = content;//页眉内容
            //创建页眉关系（headern.xml）
        ...
        public static void AddFooter(this XWPFDocument doc, string content, int c = 0)
        {
            doc.Document.body.sectPr = new CT_SectPr();
            CT_SectPr m_SectPr = doc.Document.body.sectPr;
            ...
            m_ftr.AddNewP().AddNewR().AddNewT().Value = content;//页脚内容
